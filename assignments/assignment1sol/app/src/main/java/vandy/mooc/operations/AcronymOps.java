...
public class AcronymOps
     ...
     * serves as a virtual constructor to the Ops class
     */
    ...
    public List<AcronymExpansion> doInBackground(String acronym) {
        try {
            ...
            // service.
                ...
                AcronymData result = mAcronymWebServiceProxy.getAcronymResults(acronym).get(0);//pass the short form and return the acronym
     ...
     */
    public void onPostExecute(List<AcronymExpansion> acronymExpansionsList, String acronym) {
		...
		mAsyncTask.cancel(true);//cancel the async task
