...
public class Video {
	...
	public Collection<Double> getRatingList() {
		return   ratingList;
	}
	...
	public void setRatingList(Collection<Double> ratingList) {
	...
	@ElementCollection
 	private Collection<Double> ratingList=new LinkedList<>();
	...
	public void setSubject(String subject) {
 	...
 	public void setRating(double rating) {
		...
		synchronized(this){
			int oldSize=ratingList.size();
			if(oldSize==0)this.rating=rating;
			else{
				double calcRating=this.rating*oldSize+rating;
				int newSize=ratingList.size();
				this.ratingList.add(rating);
				this.rating=calcRating/newSize;
			}

		}
		System.out.println(" rating list is:"+ratingList);
    ...
    public synchronized double getRating() {
		...
		return rating=sum/(double)ratingList.size();*/
		return this.rating;
	}
