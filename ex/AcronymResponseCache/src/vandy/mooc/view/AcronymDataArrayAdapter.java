 ...
 */
public class AcronymDataArrayAdapter 
       extends ArrayAdapter<ParcelableAcronymExpansion> {
    /**
     ...
     */
    public AcronymDataArrayAdapter(Context context,
                                   List<ParcelableAcronymExpansion> objects) {
        super(context,
              R.layout.acronym_data_row,
              objects);
    }
    ...
    public View getView(int position,
                        View convertView,
                        ViewGroup parent) {
    	ParcelableAcronymExpansion data = getItem(position);
        if (convertView == null) 
            convertView =
