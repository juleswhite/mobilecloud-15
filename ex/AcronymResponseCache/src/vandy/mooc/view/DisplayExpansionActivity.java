...
/**
 * This Activity shows the Acronym Expansions for an acronym provided by the
 * user. It expects the intent used to start the Activity to contain an extra
 * that holds acronym under the key "KEY_ACRONYM_DATA". Extends
...
public class DisplayExpansionActivity extends LifecycleLoggingActivity {
    ...
    public static Intent makeIntent(List<AcronymExpansion> results) {
        ...
        return new Intent(ACTION_DISPLAY_ACRONYM_EXPANSIONS)
            .putParcelableArrayListExtra
                (KEY_ACRONYM_DATA,
                 ParcelableAcronymExpansion.getExpansions
                     (results));
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.display_acronym_activity);
        ...
        // data from it.
        final List<ParcelableAcronymExpansion> result = 
