...
public class HobbitProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        return innitializeHobitProvider();

    }

    private boolean innitializeHobitProvider() {
    ...
    public void setContentProviderType(ContentProviderType type){
        this.mContentProviderType=type;
        innitializeHobitProvider();
    }
}
